########################################################################
# Dieses Script baut und installiert den HTWK Smart-Driving Code.      #
########################################################################
...
ADTF_DISPLAY_DIR = '/opt/adtf/2.13.1./addons/adtf-display-toolbox/'
...
if CONFIG == 'DEBUG':
    ...
    SERVICE_FILES = ['htwk_world_service.srv', 'htwk_world_filter.plb.plugindescription',
